...
Original file is located at
    https://colab.research.google.com/drive/1gHkZTOFfcQpVjrmOejnk6220O_YfoV0y

Building an AI-Powered Document Retrieval System with Docling and Granite

##  Overview

Welcome to this Notebook, in this Notebook, you'll learn to harness the power of advanced tools to build AI-powered document retrieval systems. It will guide you through:
...
This Notebook  is designed for AI developers, researchers, and enthusiasts looking to enhance their knowledge of document management and advanced NLP techniques.
...
Choosing the right **Embeddings Model** is crucial for converting your text data into meaningful numerical representations. These 'embeddings' are vital for tasks like similarity search and retrieval.

For this notebook, we'll leverage the power of one of the new **Granite Embeddings** models, designed to provide robust and effective text vectorization.

Should you wish to explore other options, you have the flexibility to replace the following code cell with an embedding model from a different provider, as detailed in our dedicated Embeddings Model recipe.
"""
...
A **Vector Database** is essential for efficiently storing and retrieving the embedding vectors generated from your documents. It allows for quick similarity searches, which are at the heart of effective RAG systems.

While we'll be demonstrating with **ChromaDB** in this notebook, its simplicity and power make it an excellent choice. However, if your project requires a different vector database, you have the flexibility to replace the following code cell with your preferred option, leveraging the insights from our comprehensive [Vector Store recipe](https://github.com/ibm-granite-community/granite-kitchen/blob/main/recipes/Components/Langchain_Vector_Stores.ipynb).
"""
...
"""Looks like it pulled some chunks that would have the information we are looking

1.   List item
2.   List item

for. Let's go ahead and contruct our RAG pipeline.
